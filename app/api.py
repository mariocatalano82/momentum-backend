...
def build_state(profile: str):
    ...
    if not all_assets: return {"error": "No data", "is_live": False}
    ...
    for a in all_assets:
        ...
        # ORA PASSIAMO 'profile' A TECH_CONTEXT
        tech = tech_context(c1h, c24, a["symbol"], prob, profile)
    ...
    return {
        "is_live": True, "market_leaders": leaders,
        "last_valid_up": up, "last_valid_down": down
    }