...
STABLECOINS = ["USDT", "USDC", "FDUSD", "TUSD", "DAI", "BUSD", "PYUSD", "USDP"]
...
def get_state(profile: str = "balanced"):
    try:
        ...
        for coin in raw_data:
            ...
            # FILTRO STABLECOIN: Se la moneta è nella blacklist, la saltiamo
            if sym_clean in STABLECOINS:
                continue
            ...
            results.append({
                ...
                "explanation": f"Analisi {sym_clean}: Momentum {'positivo' if c_24h > 0 else 'negativo'} con volumi per {int(vol/1000000)}M USD. Fiducia: {prob}%.",
